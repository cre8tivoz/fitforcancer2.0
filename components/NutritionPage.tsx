    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {orderedRecipes.length > 0 ? (
        ...
        <div className="py-12 text-center bg-white rounded-2xl border border-dashed border-slate-300">
          ...
          <button onClick={() => { onSearchChange(''); onCategoryFilterChange('All'); onRecipeZoneFilterChange('All'); }} className="mt-4 text-neon-blue font-semibold hover:underline">Clear all filters</button>
        </div>
      )}
    </div>
  );
